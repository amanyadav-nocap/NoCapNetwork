import { ChronNFT, ChronNFT__factory, Usd, Usd__factory, Vault, VaultFactory, VaultFactory__factory, Vault__factory } from "../typechain-types"
...
describe("chroncept", async () => {
    ...
    it('Buy NFT', async () => {
        ...
        await USDT.connect(signers[1]).approve(vault_instance.address, expandTo18Decimals(10));
    ...
    it('Buy NFT through multiple vault ', async () => {
        ...
        await USDT.connect(owner).mint(signers[1].address, expandTo18Decimals(1000));
        await USDT.connect(signers[1]).approve(vault_instance.address, expandTo18Decimals(10));
        await USDT.connect(signers[1]).approve(vault_instance2.address, expandTo18Decimals(20));
    ...
    it('ERROR: all fractions sold', async () => {
        ...
        await USDT.connect(owner).mint(signers[1].address, expandTo18Decimals(1000));
        await USDT.connect(signers[1]).approve(vault_instance.address, expandTo18Decimals(400));

        await vault_instance.connect(signers[1]).buyFractions(30);
        await expect(vault_instance.connect(signers[1]).buyFractions(1)).to.be.revertedWith("AFS");
    ...
    it('ERROR: Not Enough Supply', async () => {
        ...
        await expect(vault_instance.connect(signers[1]).buyFractions(31)).to.be.revertedWith("NES");
    ...
    it('ERROR : No allowance ', async () => {
        ...
        await USDT.connect(signers[1]).approve(vault_instance.address, expandTo18Decimals(10));
        await vault_instance.connect(signers[1]).buyFractions(1);
        await expect(vault_instance.connect(signers[2]).buyFractions(1)).to.be.revertedWith("ERC20: insufficient allowance");
    ...
    it('ERROR :insufficient allowance for buying fraction ', async () => {
        ...
        await USDT.connect(signers[1]).approve(vault_instance.address, expandTo18Decimals(10));
        await vault_instance.connect(signers[1]).buyFractions(1);
        await expect(vault_instance.connect(signers[1]).buyFractions(1)).to.be.revertedWith("ERC20: insufficient allowance");
    ...
    it('ERROR: Offer buyout before primary buy ends ', async () => {
        ...
        const vault_instance = await new Vault__factory(owner).attach(v1)
        await USDT.connect(owner).mint(signers[1].address, expandTo18Decimals(1000));
        await USDT.connect(signers[1]).approve(vault_instance.address, expandTo18Decimals(300));
        await vault_instance.connect(signers[1]).buyFractions(29);
        await expect(vault_instance.connect(signers[1]).makeOffer(expandTo18Decimals(200))).to.be.revertedWith("NAY");
    ...
    it('ERROR: buyout price same as nft price ', async () => {
        ...
        await vault_instance.connect(signers[1]).buyFractions(30);
        await expect(vault_instance.connect(signers[1]).makeOffer(expandTo18Decimals(10))).to.be.revertedWith("PL");
    });
    ...
    it('ERROR: buyout price too low', async () => {
        ...
        await USDT.connect(signers[1]).approve(vault_instance.address, expandTo18Decimals(1000));
        await vault_instance.connect(signers[1]).buyFractions(30);
        await expect(vault_instance.connect(signers[1]).makeOffer(expandTo18Decimals(8))).to.be.revertedWith("PL");
    });
    ...
    it('Buyout offer', async () => {
        ...
        await USDT.connect(signers[2]).approve(vault_instance.address, expandTo18Decimals(330));
    ...
    it('multiple Buyout offer ', async () => {
        ...
        await USDT.connect(signers[3]).approve(vault_instance.address, expandTo18Decimals(390));
        ...
        await USDT.connect(signers[4]).approve(vault_instance.address, expandTo18Decimals(450));
        ...
        await USDT.connect(signers[5]).approve(vault_instance.address, expandTo18Decimals(450));
    ...
    it('ERROR: voter do not hold any fraction', async () => {
        ...
        await USDT.connect(signers[1]).approve(vault_instance.address, expandTo18Decimals(900));
        await USDT.connect(signers[2]).approve(vault_instance.address, expandTo18Decimals(110));
        await USDT.connect(signers[3]).approve(vault_instance.address, expandTo18Decimals(50));
        await USDT.connect(signers[4]).approve(vault_instance.address, expandTo18Decimals(50));
        await USDT.connect(signers[5]).approve(vault_instance.address, expandTo18Decimals(100));
    ...
    it('ERROR: offerer not allowed to vote', async () => {
        ...
        await USDT.connect(owner).mint(signers[5].address, expandTo18Decimals(1000));
        await USDT.connect(signers[5]).approve(vault_instance.address, expandTo18Decimals(220));
